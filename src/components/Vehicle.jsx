...
const Vehicle = () => {
    ...
    return (
    <div name="vehicle" className="vehicle max-w-[1800px]  justify-between md:h-[800px] h-[2450px] mx-auto px-4">
      <div className="text-center ">
        <a className="text-4xl text-violet-500 ">Available Vehicles!</a>
      </div>

      <div className="font-bold  w-full mt-20 text-center gap-6 md:gap-60 grid grid-cols-1 sm:grid-cols-1 md:ml-[150px] md:mt-[150px] lg:grid-cols-3 md:h-[200px] md:w-[1300px] items-center">
